...
def test_adaptive_ema_fix():
    ...
    print("[TEST] Adaptive EMA Fix (BUG #1 & #4)...")
    try:
        ...
        print("  [OK] Adaptive EMA working correctly")
        ...
        print(f"  [FAIL] Adaptive EMA test failed: {e}")
        return False


def test_memory_handler_division_fix():
    """Test BUG #2: Division by zero in memory handler"""
    print("[TEST] Memory Handler Division Fix (BUG #2)...")
    try:
        ...
        print("  [OK] Division by zero protection working")
        print(f"      si_xi value (damping): {handler.si_xi}")
        return True
    except Exception as e:
        print(f"  [FAIL] Memory handler test failed: {e}")
        return False


def test_consciousness_variance_fix():
    """Test BUG #3: Variance computation initialization"""
    print("[TEST] Consciousness Variance Fix (BUG #3)...")
    try:
        ...
        for i in range(20):
            ...
            # observe() requires x, y_true, y_pred
            result = core.observe(x, y_true, y_pred)
        ...
        print("  [OK] Variance computation working correctly")
        print(f"      Final error_std: {core.error_std:.6f}")
        return True
    except Exception as e:
        print(f"  [FAIL] Consciousness test failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_evaluator_win_condition_fix():
    ...
    print("[TEST] Win Condition Calibration (BUG #6)...")
    try:
        ...
        print("  [OK] Win condition calibrated correctly")
        return True
    except Exception as e:
        print(f"  [FAIL] Win condition test failed: {e}")
        return False


def test_entropy_calculation_fix():
    """Test BUG #7: Entropy excluding zero color"""
    print("[TEST] Entropy Calculation Fix (BUG #7)...")
    try:
        from arc_agi3_evaluator_v2 import EnhancedSimulatedGame
        ...
        print("  [OK] Entropy calculation working correctly")
        return True
    except Exception as e:
        print(f"  [FAIL] Entropy test failed: {e}")
        return False


def test_score_calculation_fix():
    """Test BUG #5: Score calculation NaN protection"""
    print("[TEST] Score Calculation Fix (BUG #5)...")
    try:
        from arc_agi3_evaluator_v2 import EnhancedSimulatedGame
        ...
        print(f"  [OK] Score calculation safe")
        print(f"      Sample score: {score:.4f}")
        return True
    except Exception as e:
        print(f"  [FAIL] Score test failed: {e}")
        return False


def test_reward_scaling_fix():
    """Test BUG #8: Reward scaling by difficulty"""
    print("[TEST] Reward Scaling Fix (BUG #8)...")
    try:
        from arc_agi3_evaluator_v2 import EnhancedSimulatedGame
        ...
        print("  [OK] Reward scaling working correctly")
        return True
    except Exception as e:
        print(f"  [FAIL] Reward scaling test failed: {e}")
        return False


def test_consciousness_default():
    """Test BUG #12: Consciousness default set to False"""
    print("[TEST] Consciousness Default Fix (BUG #12)...")
    try:
        ...
        print("  [OK] Consciousness default configured")
        return True
    except Exception as e:
        print(f"  [FAIL] Consciousness default test failed: {e}")
        return False
